; Changes Foobar selection on current playlist every 30 seconds to next track.
; Meant to automate Bio script scrapping on a list with all artist from library.
; Used along World Map SMP, you can fetch all country tags and save them to json/tracks.
